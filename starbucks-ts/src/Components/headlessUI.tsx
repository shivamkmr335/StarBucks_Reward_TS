        ...
        <Dialog open={props.open} onClose={props.onClose}>
          ...
          >
            <div className="fixed top-10 right-0 h-screen w-1/2  z-20 p-5 bg-white transform font-myFont">
              ...
              <a className="inline-block text-sm border bg-black  border-black py-1 px-3 rounded-full mx-4 mr-5 text-white" href="https://www.starbucks.com/rewards">Join now</a>
              <a className="my-4 font-semibold text-sm block" href="https://www.starbucks.com/rewards"><svg className="w-6 inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 2.009c-2.762 0-5 2.229-5 4.99 0 4.774 5 11 5 11s5-6.227 5-11c0-2.76-2.238-4.99-5-4.99zm0 7.751a2.7 2.7 0 1 1 0-5.4 2.7 2.7 0 0 1 0 5.4z"/></svg>Find a store</a>
            </div>
          ...
          <div className="fixed top-0 left-0 right-0 bg-white flex justify-between md:hidden z-30 border-b-2">
            ...
            <button onClick={()=>props.onClose(false)} className="m-4 hover:bg-gray-200 p-1 rounded-full w-8 fixed right-3 top-2">
              <XIcon/>
            </button>
          </div>
          ...
          leaveTo="translate-x-full"
          >
            <div className="fixed top-10 right-0 h-screen w-2/4  z-20  py-5 pl-0 bg-white transform font-myFont">
              <div className="py-3">
                <button onClick={()=>setOpenSub(false)} className="py-3 pl-5 bg-gray-100 text-lg w-full flex justify-between "><span><ChevronLeftIcon className="h-5 w-5 inline-block"/></span><span>Menu</span><span></span></button>
                <button onClick={()=>props.onClose(false)} className="py-3 pl-5 text-lg w-full text-left">All Products</button>
                <button onClick={()=>props.onClose(false)} className="py-3 pl-5 text-lg w-full text-left">Featured</button>
                <button onClick={()=>props.onClose(false)} className="py-3 pl-5 text-lg w-full text-left">Previous</button>
                <button onClick={()=>props.onClose(false)} className="py-3 pl-5 text-lg w-full text-left">Favorites</button>
              </div>
            </div>
